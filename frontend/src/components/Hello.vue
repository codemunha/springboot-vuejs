<template>
  <div class="hello">
    <img src="./../assets/springboot-vuejs-logo.png">
    <h1>{{ hellomsg }}</h1>
    <h2>See the sources here: </h2>
    <ul>
      <li><a href="https://github.com/codmunha/springboot-vuejs" target="_blank">https://github.com/codmunha/springboot-vuejs</a></li>
    </ul>
